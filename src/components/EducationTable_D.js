    ...
    <div>
      {
        ...
        <div className="table-row table-row-header">
          ...
          <div style={{flex: "0 0 35px", backgroundColor: "#5c707a"}} className="table-row-element">Year</div>
      ...
      }
      {
        ...
        <div className="table-row table-row-header">
          ...
          <div style={{flex: "0 0 35px", backgroundColor: "#5c707a"}} className="table-row-element">Års-kurs</div>
